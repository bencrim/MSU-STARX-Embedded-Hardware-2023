...
//---------------------------------------------------\void loop\------------------------------------------------------------
 void loop(){
    ...
    //essentially got rid of the functions and pasted the contents of the functions into the loops
      
      //get values for first mpu having address of 0x68   
      Wire.beginTransmission(MPU1); //changed each MPU into the respective ones(MPU1 or MPU2)
      Wire.write(0x3B); // starting with register 0x3B (ACCEL_XOUT_H) 
      Wire.endTransmission(false);
      Wire.requestFrom(MPU1, 14, true); // request a total of 14 registers //changed each MPU into the respective ones(MPU1 or MPU2)
      ...
      Wire.beginTransmission(MPU2); //changed each MPU into the respective ones(MPU1 or MPU2)
      Wire.write(0x3B); // starting with register 0x3B (ACCEL_XOUT_H) 
      Wire.endTransmission(false);
      Wire.requestFrom(MPU2, 14, true); // request a total of 14 registers //changed each MPU into the respective ones(MPU1 or MPU2)
